...
*/
export abstract class ApiGenericService {
    ...
    create(endpoint: string, item: any): Observable<any> {
        const url = `${ApiGenericService.apiUrl}/${endpoint}`;
        return this.httpClient
            .post(
                ...
                timeout(ApiGenericService.EIGHT_SECONDS_TIMEOUT),
    ...
    delete(endpoint: string, id: number): Observable<any> {
        const url = `${ApiGenericService.apiUrl}/${endpoint}/${id}`;
        return this.httpClient
            .delete(
                url,
                this.getHTTPHeader()
    ...
    getHTTPHeader() {
        return {
            headers: new HttpHeaders({
                'Content-Type': 'application/json',
                'Authorization': ApiGenericService.token
            })
        };
    }
